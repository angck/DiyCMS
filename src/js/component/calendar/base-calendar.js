define('component/calendar/base-calendar', ['jquery', 'component/position', 'moment', 'component/widget/index', 'component/iframe-shim', './i18n/zh-cn', './i18n/zh-tw', './i18n/fr', './i18n/ja', './i18n/en'], function(require, exports, module) {
    var $ = require('jquery');
    var Position = require('component/position');
    var moment = require('moment');
    var Widget = require('component/widget/index');
    var Shim = require('component/iframe-shim');
