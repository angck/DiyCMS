define(['jquery', 'component/overlay/index', 'component/templatable', './data-source', './filter', './input', '../tmpl/autocomplete.handlebars', '../select.css'], function(require, exports, module) {
    var $ = require('jquery');
    var Overlay = require('component/overlay/index').Overlay;
    ...
    var template = require('../tmpl/autocomplete.handlebars');
