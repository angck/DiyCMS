define(['jquery', 'component/overlay/overlay', 'component/templatable', './tmpl/select.handlebars', './select.css'], function(require, exports, module) {
    var Overlay = require('component/overlay/overlay');
    var $ = require('jquery');
    var Templatable = require('component/templatable');
    require('./select.css')
    var template = require('./tmpl/select.handlebars');
    ...
    var Select = Overlay.extend({
        ...
        attrs: {
            ...
            // trigger 的 tpl
            triggerTpl: '<a href="javascript:void(0);"><span data-role="trigger-content"></span><i class="iconfont">&#xe609;</i></a>',
