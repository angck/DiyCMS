define('component/dialog/dialog', ['jquery', 'component/overlay/index', 'component/events', 'component/templatable', 'component/messenger', '../tmpl/dialog.handlebars', './dialog.css'], function(require, exports, module) {

    require('./dialog.css');
    var $ = require('jquery'),
        OverlayModel = require('component/overlay/index'),
        Overlay = OverlayModel.Overlay,
        mask = OverlayModel.Mask,
        Events = require('component/events'),
        Templatable = require('component/templatable'),
        Messenger = require('component/messenger');
    ...
    var Dialog = Overlay.extend({
        ...
        attrs: {
            // 模板
            template: require('../tmpl/dialog.handlebars'),
