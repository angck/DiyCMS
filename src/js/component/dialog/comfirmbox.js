define('component/dialog/comfirmbox', ['jquery', './dialog', '../tmpl/comfirmbox.handlebars'], function(require, exports, module) {
    var $ = require('jquery'),
        Dialog = require('./dialog');

    var template = require('../tmpl/comfirmbox.handlebars');
